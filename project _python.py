...
class ExpenseTracker:
    def __init__(self, root):
        ...
        self.bg_image = tk.PhotoImage(file='D:\\project.py\\money.png')  # Use double backslashes
...
class LoginPage:
    def __init__(self, master):
        ...
        self.bg_image = PhotoImage(file=r'D:\project.py\expense (2).png')  # Use double backslashes
